...
import com.sylvan.myworkdemo.imagepick.helper.CropWindowEdgeSelector;
...
public class CropImageView extends AppCompatImageView {
    ...
    private void init(@NonNull Context context) {
        ...
        mBorderPaint.setStrokeWidth(DimenUtils.dip2px(3));
        mBorderPaint.setColor(Color.parseColor("#AAFFFFFF"));

        mGuidelinePaint = new Paint();
        mGuidelinePaint.setStyle(Paint.Style.STROKE);
        mGuidelinePaint.setStrokeWidth(DimenUtils.dip2px(1));
        mGuidelinePaint.setColor(Color.parseColor("#AAFFFFFF"));


        mCornerPaint = new Paint();
        mCornerPaint.setStyle(Paint.Style.STROKE);
        mCornerPaint.setStrokeWidth(DimenUtils.dip2px(5));
        mCornerPaint.setColor(Color.WHITE);


        mScaleRadius = DimenUtils.dip2px(24);
        mBorderThickness = DimenUtils.dip2px(3);
        mCornerThickness = DimenUtils.dip2px(5);
        mCornerLength = DimenUtils.dip2px(20);
    }
    ...
    public Bitmap getCroppedImage() {
        ...
        final float cropWidth = Math.abs(Math.min(Edge.getWidth() / scaleX, originalBitmap.getWidth() - cropX));
